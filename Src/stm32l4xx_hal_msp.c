...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PC1     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(V_SCL_GPIO_Port, V_SCL_Pin);

    HAL_GPIO_DeInit(V_SDA_GPIO_Port, V_SDA_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PD13     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(RTC2_SCL_GPIO_Port, RTC2_SCL_Pin);

    HAL_GPIO_DeInit(RTC2_SDA_GPIO_Port, RTC2_SDA_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PB11     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, UNI_RX_Pin|UNI_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, DF_S_TX_Pin|DF_S_RX_Pin);
